<div class="footer-top-area pt-4 section-space-pb border-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index-2.html"><img src="{{asset('clients/assets/images/logo.png')}}" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-list">
                                <li><a href="contact-us.html">Tương tác với chúng tôi</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="footer-widget">
                            <h6 class="footer-title">Tải ngay ứng dụng của chúng tôi</h6>
                            <p class="footer-apps-dec">Nhanh chóng và tiện lợi</p>
                            <ul class="footer-apps-list">
                                <li><a href="#"><img src="{{asset('clients/assets/images/others/apple_store.png')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('clients/assets/images/others/google_play.png')}}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="copy-right-content">
                    <p>Trường đại học GTVT| Lớp CNTT2-K60| Phan Ngọc Cảnh -191202988 & Đoàn Minh Cương - 191213011</p>
                </div>
            </div>
        </div>