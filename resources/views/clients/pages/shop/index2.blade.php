                                    ...
                                    <div class="filter-price-wapper">
                                        <div class="filter-price-cont">
                                            ...
                                            <div class="input-type">
                                                <input type="text" value="{{$MinPrice}}" name="minprice" id="min-price" readonly="" />
                                            </div>
                                            <span>—</span>
                                            <div class="input-type">
                                                <input type="text" value="{{$MaxPrice}}" name="maxprice" id="max-price" readonly="" />
                                            </div>
                                            <div class="input-type">
                                                VND
                                            </div>
                                    ...
                                    <!-- Single Item Start -->
                                        <div class="single-product-item">
                                            ...
                                            <div class="single-product-item-content mt-4">                                     
                                                <h6 class="single-product-item-title"><a href="product-details.html">{{$item->TenSP}}</a></h6>
...
@section('script')
   <script>
                                    ...
                                    '<div class="col-lg-6 col-md-6 col-sm-6">'+
                                     ...
                                     if(data.GiamGia > 0)  html +='<span class="new-price">'+(data.Gia-(data.Gia*data.GiamGia)/100)+' VND</span>-'+
                                            ...
                                            '<div class="single-add-to-cart">'+
                                                '<button class="add-to-cart btn btn--primary md:px-5" type="submit" onclick="ShowMa(\''+data.MaSP+'\')">Thêm vào giỏ</button>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'+
        ...
        $(':input[name = qg]').change(function(){
            var MaXX = $(this).val();
            $.ajax({
                url: '/clients/product-national/'+MaXX,
                method: "GET",
                data:{
                    _token:'{{ csrf_token() }}'},
                dataType: "json",
